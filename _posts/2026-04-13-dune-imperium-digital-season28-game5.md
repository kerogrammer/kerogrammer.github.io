...
손패에서 **「인장 반지」**가 보이자마자 전략 방향이 확정되었습니다. 카드를 보드로 내면서 인장 반지 능력을 즉시 발동해, 나보다 영향력이 높은 팩션 두 곳에서 영향력을 각각 1씩 끌어올렸습니다.
...
1라운드 전투는 과감히 포기했습니다. 일반 리체스 백작이 전투력 **8점**으로 압도적 1위를 가져갔고, 나는 영향력 쌓기에 집중했습니다. 이것은 손해가 아니라 **미래의 동맹 솔라리를 위한 투자**였습니다.
